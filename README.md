...
- **Movimientos**: búsqueda por nota/categoría, filtros por tipo/moneda/mes (arranca en el mes actual), totales por moneda. La lista va agrupada por día, con el total de cada día al costado y la nota como línea principal. El historial largo se muestra de a tandas con "Mostrar más".
- **Resumen**: saldo por cuenta (tocás una para ajustarla al saldo real del banco); el mes con gastado, ingresado y ahorro; el ritmo del mes con promedio diario y proyección al cierre; gasto por categoría con barras, el delta contra el promedio de los últimos 6 meses y drill-down al tocar una; gasto mensual de los últimos 6 meses con selector de moneda; y el campo manual de patrimonio invertido.
- **Lo que no es gasto**: cambiar AUD a euros, comprar un ETF o prestarle plata a alguien salen de la cuenta pero no son consumo. El Resumen los saca del "Gastado" y los muestra en su propia sección, así un mes con una de esas operaciones no aparece inflado.
- **Prestado**: la plata que prestaste y todavía no volvió, por persona, con el total por moneda. Un préstamo es un Gasto con subcategoría "Préstamos"; al cargarlo te pide a quién. Marcarlo como devuelto no borra nada: escribe una marca `devuelto_<id>` en la pestaña Config. La plata que vuelve se anota como Ingreso, como cualquier otra.
